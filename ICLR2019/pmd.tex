...
maximize the prox regularized expected reward,
...
then perform multiple steps of gradient descent on the project step
...
relies on the condition that the projection step in PMD is solved to
global optimality.
