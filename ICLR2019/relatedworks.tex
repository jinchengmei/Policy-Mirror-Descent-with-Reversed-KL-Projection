...
%	\item MPO: (1) start from a variational inference point; (2) no entropy regularization: deterministic policies are all fixed points (3 ) the project step includes the trust region regularizer. (4) MPO also has very similar guarantees for non-convex settings.	 
%\end{itemize}
