...
\centering
\includegraphics[width=1.8in]{./mujoco-results/Walker2d-v2-AVE.pdf}
%\caption{Error rate}
%\label{a}
\end{minipage}%
\begin{minipage}{0.333\linewidth}
\centering
\includegraphics[width=1.8in]{./mujoco-results/Hopper-v2-AVE.pdf}
%\caption{Error rate}
%\label{a}
\end{minipage}%
\begin{minipage}{0.333\linewidth}
\centering
\includegraphics[width=1.8in]{./mujoco-results/HalfCheetah-v2-AVE.pdf}
%\caption{Error rate}
%\label{a}
\end{minipage}%
...
\begin{minipage}{0.5\linewidth}
\raggedleft
\includegraphics[width=1.8in]{./ablation.pdf}
\end{minipage}%
\begin{minipage}{0.5\linewidth}
\includegraphics[width=1.8in]{./ablation.pdf}
%\caption{Error rate}
