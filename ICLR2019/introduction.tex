...
with respect to the underlying policy parameters %parameterization
...
Joint estimation and %parameter 
...
In practice, it is known that successful application of deep RL techniques
