...
\end{lem}
Pesudeocode of the learning algorithm is presented in \cref{alg:ECPO}. Derivation for the analytic solution of the Lift Step and above Lemma as well as other implementation details can be found in the Appendix.% \cref{appx:ECPO-learning}.
