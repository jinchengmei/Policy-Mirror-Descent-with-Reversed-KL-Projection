...
Implementation details are provided in the Appendix. % \cref{subsec:implementation}. 
...
in \cref{fig:results}. 
It is clear that ECPO substantially outperforms the baseline methods
on these tasks.
ECPO appears able to consistently achieve a higher score and
...
\end{center}
\caption{Ablation Study of ECPO and ECAC %with designed baselines
