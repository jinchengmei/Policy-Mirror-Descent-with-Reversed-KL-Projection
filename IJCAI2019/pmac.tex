...
\begin{equation*}
\begin{split}
 \gO_{\text{ECPO}}(\pi, s) &= \E_{a\sim \pi(\cdot \vert s)} [ r(s,a) + \gO_{\text{ECPO}}(\pi, s') \\
...
Implementation details for ECAC are given in the Appendix.%\cref{sec:implementationECAC}. 
