...
&\qquad \qquad  \qquad \qquad \quad {{ - \tau \KL(\pi \| \pi_{\theta_t}) + \bm{\tau^{\prime} \cH(\pi)} }}.
\end{split}
\end{equation}
...
\cref{fig:srsimulation} shows the simulation
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.8\linewidth]{./sr_simulation.pdf} \vspace{-0.3cm} 
\caption{
